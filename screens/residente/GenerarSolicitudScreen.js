...
export default class GenerarSolicitudScreen extends Component {
    constructor(props) {
        super(props);
        let dataUnidadades = [];
        let i = 1;
    ...
    createSolicitud = async () => {
        ...
        const { params } = this.props.navigation.state;
        const { accessInfo } = this.props.screenProps;
        const { nombreCategoria, unidad, precioUnidad, cantidad, concepto, importe} = this.state;
        console.log('ID DEL proyecto: ', params.idProyecto);
    ...
    validaForm() {
        const { cantidad, unidad, importe, categoria, precioUnidad, concepto, nombreCategoria } = this.state;
        console.log('Ctaegoria: ', categoria);
        ...
        return (
            <KeyboardAvoidingView 
                ...
                <View style={SharedStyles.container}>
                    <HeaderGrayBack
                        title={'Solicitud ' + this.state.title}
                        action={() => {
