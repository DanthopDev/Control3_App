...
export default class RegistrarGastoScreen extends Component {
    ...
    createGasto = async () => {
        ...
        const { nombreCategoria, nombreCosto, unidad, pu, importe, cantidad, proveedor, notas, costo_id } = this.state;
                                ...
                                :   <SearchableDropdown
                                        ...
                                        onItemSelect={item => {
                                            ...
                                            if (concepto.pu == "null" || concepto.pu == "NaN") {
                                                this.setState({
                                                    costo_id: concepto.id,
                                                    pu: '',
                                                    importe: '',
                                                    proveedorIndex,
                                                    nombreCosto: concepto.name,
                                                    proveedor: this.state.dataProveedores[proveedorIndex].name,
                                                    errorCosto: false,
                                                    isSelectedUnidad: false,
                                                    isSelectedProveedor: false,
