...
import { AsyncStorage, ActivityIndicator, View, Alert, Platform, Text} from 'react-native';
import ResidenteNavigatorDrawer from '../../navigation/ResidenteNavigatorDrawer';
...
export default class LoadingDataResidenteScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
    ...
    changeState(avancesProyectos, unidades, proyectos) {
        this.setState({
            unidades: unidades,
            proyectos: proyectos,
    ...
    render() {
        return(
            <ResidenteNavigatorDrawer screenProps={this.state} />
            );
    }
}